...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
  ...
  switch( card ) 
    ...
    case smithy: ;
      int smithyReturn = smithyFunc(state, handPos, currentPlayer);
      return smithyReturn;
      break;
    
      /*old smithy will delete when done
      //+3 Cards
      for (i = 0; i < 3; i++)
	    {
	      drawCard(currentPlayer, state);
    ...
    case village: ;
      int villageReturn = villageFunc(state, handPos, bonus, currentPlayer);
    ...
    case minion: ;
      int minionReturn = minionFunc(choice1, choice2, state, handPos, currentPlayer, i, j);
      return minionReturn;
      break;
    
    /*original minion code
      //+1 action
      state->numActions++;
...
/*I am putting the following refactored cardEffect functions in this location (prototypes in dominion_helper.h)!!!!
I have also introduced the following bugs into the code, written after the colon
