...
int main(){
    ...
    printf("Running 100 tests with random test states on village\n");
    ...
    for(i = 0; i < NUM_TESTS; i++){
      ...
      printf("Pre Village play playedCardCount %d\n", G.playedCardCount);
        ...
        playCard(0, 0, 0, 0, &G); //play card 0 which corresponds to village as set earlier
